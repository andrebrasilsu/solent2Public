...
public class BankApiImpl implements BankApi {
    ...
    public CreditCard createNewCreditCard(Account account) {
        ...
        CreditCardFactoryAndValidator createCard = null;
        CreditCard c = new CreditCard();
        CreditCard createdCard; 
        
        //Creates new credit card
        createdCard = createCard.createCreditCard(account.getIndividualAccountIdentifier(), account.getName(), c.getEndDate(), c.getIssueNumber());
